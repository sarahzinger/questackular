app.factory('storeFactory', function($http, domain) {
    return {
        getAllProds: function() {
            ...
            return $http.get(domain + '/api/store/').then(function(res) {
                return res.data;
            });
        },
        getUserData: function() {
            //gets user's array of owned products and their current total points and their points spent
            return $http.get(domain + '/api/store/userData').then(function(res) {
                return res.data;
            });
        },
        userBuy: function(boughtObj) {
            ...
            return $http.post(domain + '/api/store/buy', boughtObj).then(function(res) {
                return res.data;
            });
        }
    }
